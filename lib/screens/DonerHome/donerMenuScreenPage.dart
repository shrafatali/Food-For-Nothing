...
import 'package:foodfornothing/screens/DonerHome/BottomNavBarPages/orders/doner_orders.dart';
import 'package:foodfornothing/screens/DonerHome/Pages/About_Us.dart';
import 'package:foodfornothing/screens/DonerHome/Pages/History/History.dart';
import 'package:foodfornothing/screens/DonerHome/Pages/Report.dart';
import 'package:foodfornothing/screens/profile_page.dart';
import 'package:foodfornothing/splash.dart';

class DonerMenuScreenPage extends StatefulWidget {
  const DonerMenuScreenPage({Key key}) : super(key: key);

  @override
  State<DonerMenuScreenPage> createState() => _DonerMenuScreenPageState();
}

class _DonerMenuScreenPageState extends State<DonerMenuScreenPage> {
  var userData;
                            ...
                            Navigator.of(context).push(
                              PageRouteBuilder(
                                ...
                                pageBuilder: (BuildContext context,
                                    Animation<double> animation,
                                    Animation<double> secAnimation) {
                                  return const DonerOrderStatusPage();
                                },
                              ),
                            );
                          },
